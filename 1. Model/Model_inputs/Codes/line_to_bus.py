...
folder_model = '/Volumes/ElSoldeCusco/1. Research/18. 2nd paper/8. Github/M2S_extended/1. Model/'

df = pd.read_csv(folder_model + 'data_transparams.csv',header=0)
...
df_unique.to_csv(folder_model+'unique_nodes.csv')
...
df_line_to_bus.to_csv(folder_model + 'line_to_bus.csv')
...
df_line_params.to_csv(folder_model + 'line_params.csv')